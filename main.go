...
type Car struct {
	...
	IsHybrid   bool
	Vehicle    Vehicle
} // we don't extend classes here. That concept is in OOPs.
// Go is not OOP language. It uses composition. Where we can use other self defined type in another type.
